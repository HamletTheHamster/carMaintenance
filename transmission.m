function [ yn ] = transmission( cm )
%This function takes current mileage as input and determines whether a 
% transmission fluid change is required on the next oil change, based on
% a schedule of every 60,000 miles. If the fluid change is due, it prints
% "-Transmission Fluid" among a list of any other required services on
% that oil change.
%
%   cm = current mileage
...
if yn == 1
    fprintf('   -Transmission Fluid\n') %Prints "Transmission Fluid" among 
